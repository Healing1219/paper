...
%
\usepackage{graphicx,amsfonts,algorithm,algorithmic,multirow,amsmath,xcolor,bm,makecell,balance,subfigure,caption,color,amssymb,hyperref}
\hypersetup{
	colorlinks=true,
	linkcolor=blue,
	filecolor=blue,
...
%
\titlerunning{PROPER: a Tool for Analyzing Termination and Assertions}
...
%
\institute{Shanghai Key Laboratory of Trustworthy Computing,\\East China Normal University, Shanghai, China \\ \email{51184501088@stu.ecnu.edu.cn}  
